...
public static class Strings
{
    ...
    public static string Dialog_EasyTierAgreementTitle => Get(nameof(Dialog_EasyTierAgreementTitle));
    public static string Dialog_EasyTierAgreementMessagePrefix => Get(nameof(Dialog_EasyTierAgreementMessagePrefix));
    public static string Dialog_EasyTierAgreementMessageProvider => Get(nameof(Dialog_EasyTierAgreementMessageProvider));
    public static string Dialog_EasyTierAgreementMessageSuffix => Get(nameof(Dialog_EasyTierAgreementMessageSuffix));
    public static string Dialog_EasyTierAgreementLink => Get(nameof(Dialog_EasyTierAgreementLink));
    public static string Dialog_EasyTierAgreementMessageAnd => Get(nameof(Dialog_EasyTierAgreementMessageAnd));
    public static string Dialog_EasyTierPrivacyPolicyLink => Get(nameof(Dialog_EasyTierPrivacyPolicyLink));
    public static string Dialog_EasyTierAgreementMessageEnd => Get(nameof(Dialog_EasyTierAgreementMessageEnd));
    public static string Dialog_EasyTierDownloadNotice => Get(nameof(Dialog_EasyTierDownloadNotice));
    public static string Dialog_EasyTierDisagreeButton => Get(nameof(Dialog_EasyTierDisagreeButton));
    public static string Dialog_EasyTierAgreeButton => Get(nameof(Dialog_EasyTierAgreeButton));
    public static string Dialog_EasyTierDownloadPreparing => Get(nameof(Dialog_EasyTierDownloadPreparing));
    public static string Dialog_EasyTierDownloading => Get(nameof(Dialog_EasyTierDownloading));
    public static string Dialog_EasyTierExtracting => Get(nameof(Dialog_EasyTierExtracting));
    public static string Dialog_EasyTierDownloadComplete => Get(nameof(Dialog_EasyTierDownloadComplete));
    public static string Dialog_EasyTierDownloadFailed => Get(nameof(Dialog_EasyTierDownloadFailed));
    public static string Status_EasyTierReady => Get(nameof(Status_EasyTierReady));
    public static string Status_EasyTierDownloadFailed => Get(nameof(Status_EasyTierDownloadFailed));
    public static string Status_OpenEasyTierLegalDocumentFailed => Get(nameof(Status_OpenEasyTierLegalDocumentFailed));
